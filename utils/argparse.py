...
class ConfigurationParer():
    ...
    def __init__(self,
                 ...
                 **kwargs):
        """This function decides config parser and formatter
    ...
    def add_data_cfgs(self):
        ...
        self.parser.add('-vocabulary_file', '--vocabulary_file', type=str, required=False, help='vocabulary file.')
        ...
        self.parser.add('-entity_schema', '--entity_schema', type=str, required=True, help='entity tag schema.')
        self.parser.add('-low_case', '--low_case', type=int, required=True, help='tansform to low case')
    ...
    def add_model_cfgs(self):
        ...
        group.add('-entity_model',
                  '--entity_model',
                  type=str,
                  choices=["joint", "pipeline", "max", "mean", "cnn"],
                  default="joint",
        ...
        group.add('-lstm_layers', '--lstm_layers', type=int, default=1, help='number of lstm layers.')
        ...
        # relation model configurations
        group = self.parser.add_argument_group('Relation-Model')
        group.add('-relation_model',
                  '--relation_model',
                  type=str,
                  choices=["concat", "cnn"],
                  default="cnn",
                  help='relation typing model.')
        ...
        group.add('-ent_output_size', '--ent_output_size', type=int, default=0, help='entity model output size.')
        ...
        group.add('-permutation_batch_size',
                  '--permutation_batch_size',
                  type=int,
                  default=-1,
                  help='entity mention permutation batch size.')
        group.add('-permutation_samples_num',
                  '--permutation_samples_num',
                  type=int,
                  default=1,
                  help='entity mention permutation samples amount.')
        group.add('-confused_batch_size',
                  '--confused_batch_size',
                  type=int,
                  default=-1,
                  help='confused context batch size.')
        group.add('-confused_samples_num',
                  '--confused_samples_num',
                  type=int,
                  default=1,
                  help='confused context samples amount.')
        ...
        group.add('-temperature', '--temperature', type=float, default=0.07, help='contrastive loss temperature.')
        group.add('-queue_size', '--queue_size', type=int, default=128, help='contrastive loss query queue size.')
